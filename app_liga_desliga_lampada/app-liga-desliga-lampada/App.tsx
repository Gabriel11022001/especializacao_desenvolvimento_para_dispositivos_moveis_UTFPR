  ...
  return (
    <SafeAreaView style={ { flex: 1, padding: 20, backgroundColor: "#323232", alignItems: "center" } }>
      <ScrollView style={ { flex: 1 } }>
        <Image style={  styles.imgLampada } source={ statusLampada === StatusLampada.ligado ? require("./assets/images/lampada_ligada.png")
          : require("./assets/images/lampada_desligada.png")
         } />
         <TouchableOpacity 
